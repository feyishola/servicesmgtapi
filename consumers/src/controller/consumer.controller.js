...
class ConsumerController{
    ...
    async createConsumer(consumerName,phoneNumber,locationUpdate,permanentAddress,temporaryAddress,password){
    ...
    async updateConsumer(id,consumerName,phoneNumber,locationUpdate,permanentAddress,temporaryAddress,userType,password,services){
        const result = await ConsumerModel.findByIdAndUpdate({_id:id},{$set:{consumerName,phoneNumber,locationUpdate,permanentAddress,temporaryAddress,userType,password,services}})
        return result
    }
